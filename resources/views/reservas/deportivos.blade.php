...
@section('content')
    ...
    <div class="row" ng-app="reservas_module" ng-controller="reservasController" ng-cloak>
        <div class="col-md-8">
            @if(session('mensaje_error'))
                ...
                @endcomponent
            @endif
            {!! Form::open(['route'=>['registro-reserva', 'bienestar universitario'],'method' => 'post', 'class' => 'form-horizontal']) !!}
            <div class="box box-danger">
                <div class="box-body">
                    @include('layouts.includes.datos_usuario')
                    @include('layouts.includes.datos_reserva')
                    <h4>Seleccionar escenario</h4>
                    <smal>Para buscar un escenario presione <code>ctrl + f</code></smal>
    ...
    ['progress' => false, 'icon'=> 'fa-star-o', 'bg' => 'bg-yellow'])
            ...
            @endcomponent
            {!! Form::hidden('tipo_reserva', 'bienestar universitario', ['id' => 'tipo_reserva']) !!}
        </div>
    </div>
@endsection